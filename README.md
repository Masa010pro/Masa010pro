...
![Banner](https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,100:00c6ff&height=200&section=header&text=Masanso%20David&fontSize=40&fontColor=ffffff&animation=fadeIn&fontAlignY=35)

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?size=22&duration=3000&color=00C6FF&center=true&vCenter=true&width=500&lines=Software+Engineering+Student;Android+Developer;System+Builder;Tech+Explorer" />
</p>
...
- Local network-based platform accessible within a village  
- Server setup with multi-user access over LAN  
- Real-world networking and deployment experience  

### 📱 Android Calculator App
- Built using Android Studio  
- Handles arithmetic operations with clean UI  

### 🤖 Offline AI System
- AI system designed to run without internet  
